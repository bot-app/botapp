...
import { createNodeMiddleware, createBotapp, Botapp } from "../src/index.js";
...
describe("createNodeMiddleware", () => {
  ...
  test("with createBotapp and setting the webhookPath via WEBHOOK_PATH to the root", async () => {
    expect.assertions(1);
  ...
  test("with createBotapp and setting the webhookPath to the root via the deprecated webhooksPath", async () => {
    expect.assertions(1);
