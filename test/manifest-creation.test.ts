  ...
  describe("getManifest", () => {
    ...
    test("creates an app from a code", () => {
      ...
      expect(setup.getManifest(pkg, "localhost://3000")).toEqual(
        '{"description":"A framework for building GitHub Apps to automate and improve your workflow","hook_attributes":{"url":"localhost://3000/"},"name":"botapp","public":true,"redirect_url":"localhost://3000/botapp/setup","url":"https://botapp.github.io","version":"v1"}',
      );
    });
    ...
    test("creates an app from a code with overrided values from app.yml", () => {
      ...
      expect(setup.getManifest(pkg, "localhost://3000")).toEqual(
        '{"description":"A description for a cool app","hook_attributes":{"url":"localhost://3000/"},"name":"cool-app","public":true,"redirect_url":"localhost://3000/botapp/setup","url":"https://botapp.github.io","version":"v1"}',
      );
    });
  });
});
