...
import { Botapp, Server } from "../../src/index.js";
...
describe("Setup app", () => {
  ...
  beforeEach(async () => {
    ...
    server = new Server({
      Botapp: Botapp.defaults({
        ...
        // workaround for https://github.com/bot-app/botapp/issues/1512
        appId: 1,
  ...
  describe("logs", () => {
    it("should log welcome message", () => {
      const expMsgs = [
        "",
        "Welcome to Botapp!",
        "Botapp is in setup mode, webhooks cannot be received and",
  ...
  describe("GET /botapp", () => {
    it("returns a 200 response", async () => {
      await request(server.expressApp).get("/botapp").expect(200);
    });
  });

  describe("GET /botapp/setup", () => {
