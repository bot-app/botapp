...
const { createBotapp } = require('../lib/create-botapp');
...
const middleware = createNodeMiddleware(appFn, { botapp: createBotapp() });

const server = createServer(middleware);

server.listen(3000, async () => {
  console.log("Botapp started http://localhost:3000/")
