...
<head>
    ...
    <title>Import ${name || "Your App"} | built with Botapp</title>
...
<body class="bg-gray-light">
    <div class="d-flex flex-column flex-justify-center flex-items-center text-center height-full py-6">
        <a href="/botapp"><img src="/botapp/static/robot.svg" alt="Botapp Logo" width="100" class="mb-6"></a>
    ...
    <script>
        function onSubmit(e) {
            ...
            file.text().then((text) => fetch('', {
                ...
                if (r.ok) {
                    location.replace('/botapp/success');
                }
            }).catch((e) => alert(e));
            return false;
        }
