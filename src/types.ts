...
// See https://github.com/bot-app/botapp/issues/1388
// See https://github.com/bot-app/botapp/issues/1815 as for why this is in a seperate type, and not directly passed to `Webhooks`
type SimplifiedObject = Omit<Context, keyof WebhookEvent>;
export type BotappWebhooks = Webhooks<SimplifiedObject>;
...
export type OctokitOptions = NonNullable<
  ConstructorParameters<typeof BotappOctokit>[0]
>;
