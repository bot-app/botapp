...
import type { BotappOctokit } from "./botapp-octokit.js";
...
export async function getAuthenticatedOctokit(
  ...
  return octokit.auth({
    ...
    factory: ({ octokit, octokitOptions, ...otherOptions }: FactoryOptions) => {
      ...
      const options: ConstructorParameters<typeof BotappOctokit>[0] & {
      ...
      const Octokit = octokit.constructor as typeof BotappOctokit;

      return new Octokit(options);
    },
  }) as Promise<BotappOctokit>;
}
