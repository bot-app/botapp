...
import type { BotappOctokit } from "./octokit/botapp-octokit.js";
...
export class Context<Event extends WebhookEvents = WebhookEvents> {
  ...
  public octokit: BotappOctokit;
  public log: Logger;

  constructor(event: WebhookEvent<Event>, octokit: BotappOctokit, log: Logger) {
   ...
   * you can `context.octokit.config.get(options)`, see https://github.com/bot-app/octokit-plugin-config.
   *
