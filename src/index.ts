...
export { Botapp } from "./botapp.js";
export { Server } from "./server/server.js";
export { BotappOctokit } from "./octokit/botapp-octokit.js";
export { run } from "./run.js";
export { createNodeMiddleware } from "./create-node-middleware.js";
export { createBotapp } from "./create-botapp.js";
...
declare global {
  namespace NodeJS {
    interface ProcessEnv {
       ...
       * value as optional, but for optimal security it's required for Botapp
       * apps.
       *
       * @example 'development'
       * @default 'development'
