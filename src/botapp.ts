...
import { getBotappOctokitWithDefaults } from "./octokit/get-botapp-octokit-with-defaults.js";
...
export class Botapp {
  ...
  static defaults<S extends Constructor>(this: S, defaults: Options) {
    const BotappWithDefaults = class extends this {
    ...
    return BotappWithDefaults;
  }

  public webhooks: BotappWebhooks;
  public webhookPath: string;
  public log: Logger;
  public version: String;
  public on: BotappWebhooks["on"];
  public onAny: BotappWebhooks["onAny"];
  public onError: BotappWebhooks["onError"];
  public auth: (
    installationId?: number,
    log?: Logger,
  ) => Promise<BotappOctokit>;
  ...
  constructor(options: Options = {}) {
    ...
    const Octokit = getBotappOctokitWithDefaults({
      githubToken: options.githubToken,
      Octokit: options.Octokit || BotappOctokit,
