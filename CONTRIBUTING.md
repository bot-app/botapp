...
To submit a pull request for a previous version of Botapp, checkout the maintenance branch before creating a new branch, e.g. `git checkout 7.x && git checkout -b my-branch-name`. When submitting the pull request, set the base branch to the same maintenance branch.
...
Use [this search][good-first-issue-search] to find Botapp apps that have issues marked with the `good-first-issue` label.
...
[fork]: https://github.com/bot-app/botapp/fork
[pr]: https://github.com/bot-app/botapp/compare
[style]: https://prettier.io/
[code-of-conduct]: CODE_OF_CONDUCT.md
[good-first-issue-search]: https://github.com/search?utf8=%E2%9C%93&q=topic%3Abotapp+topic%3Abotapp-app+good-first-issues%3A%3E0&type=
[linter]: https://github.com/bot-app/botapp/blob/ts-readme/tslint.json
